...
public class IndiceInvertidoAVL {
    private AVLAdaptado indice_invertido;
    private String termos;

    public IndiceInvertidoAVL() {
        indice_invertido = new AVLAdaptado();
        termos = "";
    }
    ...
    private void identificarTermos(String frase, int id_atual) {
        ...
        for (String termo : termos) {
            ...
            if (this.indice_invertido.busca(termo) != null) {
                // Se termo ja existe na lista
                /*
                 * Percorrer lista dentro da chave para tentar encontrar ID existente
                 * */
                ArrayList<ParOcorrenciasID> lista = indice_invertido.busca(termo).getPares();
                ...
                this.indice_invertido.insere(termo, ParesOcorrenciasID); // (Passo 2)
            }
        }
    }

//    public void printarEstrutura(){
//        for (String key : this.indice_invertido.) {
...
//    }
    ...
    public AVLAdaptado getIndiceInvertido() {
